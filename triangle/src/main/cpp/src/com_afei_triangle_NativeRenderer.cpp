...
extern "C" JNIEXPORT void JNICALL Java_com_afei_triangle_NativeRenderer_glInit
...
extern "C" JNIEXPORT void JNICALL Java_com_afei_triangle_NativeRenderer_glResize
        (JNIEnv *env, jobject instance, jint width, jint height) {
    glViewport(0, 0, width, height); // 设置视距窗口
}

extern "C" JNIEXPORT void JNICALL Java_com_afei_triangle_NativeRenderer_glDraw
        (JNIEnv *env, jobject instance) {
    GLint vertexCount = 3;
...
extern "C" JNIEXPORT void JNICALL Java_com_afei_triangle_NativeRenderer_registerAssetManager
